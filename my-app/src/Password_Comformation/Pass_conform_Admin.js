    ...
    const { register, handleSubmit, formState: { errors }, } = useForm();
        ...
        const onSubmit = (data) => {
            if(data.Password1==data.Password2){
                console.log(data);
                axios.put('http://localhost:5000/AdminData/Password_Comformation', data)
                .then((data) => { console.log(data);alert(`Your Password has been recorded for email  , You can now leave this page and Login now`)})
            ...
            <div className={styles.content}>
                ...
                <div>
                    <div className={styles.header}>
                        ...
                        <h1 className={styles.head}>Welcome to Ahya Team (Admin)</h1>
                    </div>
                </div>
...
export default Pass_conform_Admin;
